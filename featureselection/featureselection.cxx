...
void FeatureSelection::SetFeatureSubsetRange(int subsetSizeMin,
		int subsetSizeMax) {
...
int FeatureData::LoadFeatureData(char * filename) {
	...
	if (!in) {
		cerr << "FeatureData::LoadFeatureData( char * ): Cannot open file \""
				<< filename << "\"." << endl;
		return -1;
	}
...
FeatureResults::FeatureResults(double evaluation, int clusters,
